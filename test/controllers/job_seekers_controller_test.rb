...
class JobSeekersControllerTest < ActionController::TestCase
  ...
  test "should create job_seeker" do
    assert_difference('JobSeeker.count') do
      post :create, job_seeker: { e-mail: @job_seeker.e-mail, name: @job_seeker.name, phone_number: @job_seeker.phone_number, resume: @job_seeker.resume, skills[]: @job_seeker.skills[] }
    end
  ...
  test "should update job_seeker" do
    patch :update, id: @job_seeker, job_seeker: { e-mail: @job_seeker.e-mail, name: @job_seeker.name, phone_number: @job_seeker.phone_number, resume: @job_seeker.resume, skills[]: @job_seeker.skills[] }
    assert_redirected_to job_seeker_path(assigns(:job_seeker))
  end
